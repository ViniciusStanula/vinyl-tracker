...
Este ranking usa a nota do MusicBrainz, ponderada pelo número de avaliações, combinada com o número de ouvintes no Last.fm e com a procura entre colecionadores do Discogs, medida pela relação entre quem já tem o disco e quem ainda quer. Abaixo de cada disco, um vídeo oficial de uma faixa representativa.`,
...
Este ranking usa a nota do MusicBrainz, ponderada pelo número de avaliações, combinada com o número de ouvintes no Last.fm e com a procura entre colecionadores do Discogs, medida pela relação entre quem já tem o disco e quem ainda quer. Abaixo de cada disco, um vídeo oficial de uma faixa representativa.`,
  "linkin-park": `O Linkin Park se formou em Agoura Hills, na Califórnia, em 1996, a partir de uma banda de colégio chamada Xero, com Mike Shinoda, Brad Delson e Rob Bourdon. Chester Bennington entrou como vocalista em 1999, vindo de Phoenix, e a formação se fechou com Joe Hahn nas picapes e Dave Farrell no baixo.

A mistura de rap, rock pesado e eletrônica que o grupo levou ao topo das paradas definiu o som do nu metal no começo dos anos 2000, e o disco de estreia virou um dos mais vendidos do século. A partir de Minutes to Midnight a banda passou a se afastar dessa fórmula, e cada álbum seguinte mudou de rumo de propósito, nem sempre com a base junto.

Chester Bennington morreu em 20 de julho de 2017, dois meses depois do lançamento de One More Light. O grupo ficou parado até 2024, quando voltou com a vocalista Emily Armstrong e o baterista Colin Brittain.

Este ranking usa a nota do MusicBrainz, ponderada pelo número de avaliações, combinada com o número de ouvintes no Last.fm e com a procura entre colecionadores do Discogs, medida pela relação entre quem já tem o disco e quem ainda quer. Abaixo de cada disco, um vídeo oficial de uma faixa representativa.`,

  radiohead: `O Radiohead se formou em Abingdon, na Inglaterra, em 1985, quando os cinco integrantes ainda estudavam na mesma escola. Thom Yorke, os irmãos Jonny e Colin Greenwood, Ed O'Brien e Philip Selway seguem juntos desde então, sem nenhuma troca de formação.

O primeiro sucesso, "Creep", quase virou uma armadilha: a banda passou anos evitando tocá-la e usou os discos seguintes para se afastar do rock de guitarra que a rádio esperava dela. OK Computer, de 1997, e Kid A, de 2000, marcaram essa virada, o segundo trocando boa parte das guitarras por sintetizadores, sopros e programação.

Em 2007 o grupo lançou In Rainbows por conta própria, em um site em que cada pessoa escolhia quanto pagar, inclusive nada, episódio que rendeu mais manchetes do que o próprio disco na época.
...
export const ALBUM_BLURBS: Record<string, Record<string, string>> = {
  metallica: {
    lulu: `Álbum gravado em parceria com Lou Reed, lançado em 31 de outubro de 2011. As letras partem de duas peças do dramaturgo alemão Frank Wedekind, com Reed cantando e recitando por cima da banda. Foi recebido com hostilidade quase unânime por crítica e público, e carrega a nota mais baixa da discografia do Metallica no MusicBrainz.`,
  ...
  "linkin-park": {
    "hybrid theory": `Álbum de estreia, lançado em 24 de outubro de 2000 pela Warner Bros. com produção de Don Gilmore. Passou de dez milhões de cópias vendidas só nos Estados Unidos, marca que nenhum outro disco de estreia alcançou neste século. Saíram como singles "One Step Closer", "Crawling", que rendeu um Grammy, e "In the End", que virou a canção mais conhecida do grupo. O título vem da ideia que sustenta o disco: cruzar rap e rock pesado como se fossem um gênero só.`,
    meteora: `Segundo álbum, lançado em 25 de março de 2003, de novo com Don Gilmore na produção. O nome vem do complexo de mosteiros de Metéora, na Grécia, erguidos no alto de formações rochosas. "Somewhere I Belong", "Faint" e "Numb" foram os singles principais, e "Numb" acabou se tornando a faixa mais ouvida da banda em streaming, décadas depois do lançamento.`,
    reanimation: `Disco de remixes lançado em 30 de julho de 2002, com as faixas de Hybrid Theory reconstruídas por convidados do hip hop e da eletrônica, entre eles Black Thought, Aceyalone, Pharoahe Monch e Jonathan Davis. Mike Shinoda coordenou o projeto e assinou parte das remixagens. Os títulos aparecem deformados de propósito, como em "Pts.OF.Athrty" e "Ppr:Kut".`,
    "minutes to midnight": `Terceiro álbum de estúdio, lançado em 14 de maio de 2007, produzido por Rick Rubin e Mike Shinoda depois de quase dois anos de trabalho e mais de cem canções esboçadas. É o disco em que a banda larga boa parte do rap metal da fase anterior: "What I've Done" e "Shadow of the Day" puxam o som para o rock direto. O título faz referência ao Relógio do Juízo Final.`,
    "a thousand suns": `Quarto álbum, lançado em 8 de setembro de 2010, também com Rick Rubin e Mike Shinoda na produção. É um trabalho conceitual sobre medo nuclear e guerra, com faixas curtas que emendam umas nas outras e trechos de discursos, entre eles de Robert Oppenheimer e Martin Luther King. Dividiu a base, e o grupo assumiu a ruptura como proposital.`,
    "living things": `Quinto álbum, lançado em 26 de junho de 2012, apresentado pela banda como um meio-termo entre a eletrônica de A Thousand Suns e o peso dos dois primeiros discos. "Burn It Down" foi o single de trabalho, e as letras voltam a um tom mais pessoal depois de dois álbuns de temática ampla.`,
    "the hunting party": `Sexto álbum, lançado em 13 de junho de 2014, produzido por Mike Shinoda e Brad Delson. Depois de dois discos mais eletrônicos, o grupo voltou de propósito ao peso e à velocidade, com participações de Page Hamilton, do Helmet, Tom Morello, do Rage Against the Machine, e Daron Malakian, do System of a Down.`,
    "one more light": `Sétimo álbum, lançado em 19 de maio de 2017, o mais pop da discografia, com composição dividida com autores de fora e foco em melodia e letra no lugar do peso. Foi recebido com hostilidade por parte da base, e a banda respondeu publicamente às críticas. Chester Bennington morreu dois meses depois do lançamento, e o disco passou a ser ouvido de outro jeito, sobretudo a faixa que dá nome a ele e "Heavy".`,
    "from zero": `Oitavo álbum, lançado em 15 de novembro de 2024, o primeiro depois da morte de Chester Bennington e o primeiro com a vocalista Emily Armstrong e o baterista Colin Brittain. O nome remete a Xero, como a banda se chamava antes de existir Linkin Park, e à ideia de recomeço. "The Emptiness Machine" abriu a divulgação.`,
  },

  radiohead: {
    "pablo honey": `Álbum de estreia, lançado em 22 de fevereiro de 1993 pela Parlophone e gravado em poucas semanas com Sean Slade e Paul Q. Kolderie na produção. "Creep" passou despercebida no Reino Unido no primeiro lançamento e só estourou depois de tocar em rádios de Israel e dos Estados Unidos, o que levou a gravadora a relançá-la. O sucesso da canção incomodou tanto a banda que ela sumiu dos shows por anos.`,
    "the bends": `Segundo álbum, lançado em março de 1995 com John Leckie na produção. É o disco que tirou o Radiohead do rótulo de banda de um sucesso só, com "Fake Plastic Trees", "High and Dry" e "Street Spirit (Fade Out)". A gravação foi longa e tensa, feita sob pressão da gravadora para repetir o desempenho comercial de "Creep".`,
    "ok computer": `Terceiro álbum, lançado em 21 de maio de 1997, gravado em boa parte na mansão St Catherine's Court, de Jane Seymour, com Nigel Godrich na produção. As letras tratam de alienação, consumo e tecnologia, e as músicas fogem do formato de single: "Paranoid Android" passa de seis minutos e muda de seção várias vezes. Aparece com frequência no topo das listas de melhores discos já gravados.`,
    "kid a": `Quarto álbum, lançado em 2 de outubro de 2000 e gravado nas mesmas sessões de Amnesiac. A banda trocou boa parte das guitarras por sintetizadores modulares, ondas Martenot, sopros e edição digital, e não lançou nenhum single convencional nem clipe tradicional para divulgá-lo. Dividiu a crítica na época e passou a encabeçar as listas de melhores da década anos depois.`,
    amnesiac: `Quinto álbum, lançado em 5 de junho de 2001, feito das mesmas sessões de Kid A mas apresentado como disco próprio, não como sobras. É mais fragmentado que o anterior e passa por jazz, eletrônica e música de câmara, com "Pyramid Song" e "I Might Be Wrong" entre as faixas mais conhecidas. Fecha com "Life in a Glasshouse", gravada ao lado de uma banda de jazz tradicional.`,
    "hail to the thief": `Sexto álbum, lançado em 9 de junho de 2003, gravado em duas semanas em Los Angeles com Nigel Godrich, num processo bem mais rápido que o dos discos anteriores. Junta as guitarras que a banda tinha deixado de lado à eletrônica da fase Kid A. O título e boa parte das letras remetem ao clima político do começo dos anos 2000.`,
    "in rainbows": `Sétimo álbum, lançado em 10 de outubro de 2007 sem gravadora, em um site em que cada pessoa escolhia quanto pagar, inclusive nada. A forma de lançamento rendeu mais manchetes que o disco na época, mas o álbum ficou como um dos melhores da banda, com "Nude", "Weird Fishes/Arpeggi" e "Jigsaw Falling into Place".`,
    "the king of limbs": `Oitavo álbum, lançado em 18 de fevereiro de 2011, o mais curto da discografia, com oito faixas e pouco menos de quarenta minutos. É construído sobre loops, samples e ritmos quebrados, e o clipe de "Lotus Flower", com Thom Yorke dançando sozinho, virou material de paródia imediata. O nome vem de um carvalho antigo em Wiltshire.`,
    "a moon shaped pool": `Nono álbum, lançado em 8 de maio de 2016, com arranjos de cordas e coral escritos por Jonny Greenwood e gravados pela London Contemporary Orchestra. Traz registros finalmente feitos em estúdio de canções que a banda tocava havia anos, entre elas "True Love Waits", de 1995. As faixas aparecem em ordem alfabética.`,
  },
};
